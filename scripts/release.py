...
def main():
    ...
    # 3. Pull latest changes from master into the current branch
    ...
    if current_branch == "master":
        ...
        run_cmd(["git", "merge", "origin/master", "--no-edit"])
    ...
    # 6. If we are on master, create a release branch for the PR
    ...
    pr_base = "master"
    pr_head = release_branch if current_branch == "master" else current_branch
