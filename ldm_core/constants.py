...
# LDM_MAGIC_VERSION: 2.4.26-beta.15
VERSION = "2.4.26-beta.15"
...
META_VERSION = "2.4.26-beta.15"
MIN_META_VERSION = 2
PROJECT_META_FILE = "meta"
REGISTRY_FILE = "registry.json"
TAG_PATTERN = r"^\d{4}\.q[1-4]\.\d+(-u\d+|-lts)?$"
SCRIPT_DIR = Path(__file__).parent.parent.resolve()
ELASTICSEARCH_VERSION = "2.4.26-beta.15"
ELASTICSEARCH7_VERSION = "2.4.26-beta.15"
TRAEFIK_VERSION = "2.4.26-beta.15"
