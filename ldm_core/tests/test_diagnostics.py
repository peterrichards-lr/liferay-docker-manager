...
class MockDiagManager(DiagnosticsHandler):
    ...
    def find_dxp_roots(self, *args, **kwargs):
        return [{"path": Path("/tmp/proj1"), "version": "2025.q1.0"}]
...
class TestDiagnostics(unittest.TestCase):
    ...
    def test_cmd_doctor_basic(self, mock_update, mock_verify):
        mock_verify.return_value = ("Verified", True, "1.6.33")
        mock_update.return_value = ("1.6.33", None)
