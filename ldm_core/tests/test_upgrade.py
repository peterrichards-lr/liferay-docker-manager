...
class TestVersionUpgrades(unittest.TestCase):
    ...
    @patch(
        "ldm_core.pipelines.run.get_compose_cmd",
        return_value=["docker", "compose"],
    )
    @patch("ldm_core.pipelines.run.UI.confirm", return_value=True)
    @patch("ldm_core.pipelines.run.UI.warning")
    ...
    @patch("ldm_core.pipelines.run.UI.confirm", return_value=False)
    @patch("ldm_core.pipelines.run.UI.warning")
    ...
    @patch("ldm_core.pipelines.run.UI.confirm")
    @patch("ldm_core.pipelines.run.UI.warning")
