...
| `visual-dashboard` | Visual Health Dashboard | Medium | Completed | [Plan](./tracks/visual-dashboard/plan.md) |
...
| `cli-namespacing` | CLI Namespacing | Low | Completed | [Plan](./tracks/cli-namespacing/plan.md) |
