...
2. Open your WSL terminal and set the `CAROOT` environment variable to point to the Windows `mkcert` directory. Replace `<YourWindowsUsername>` with your actual Windows username:
