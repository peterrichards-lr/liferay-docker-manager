...
| **Apple Intel** | macOS 12 Monterey | **Unknown** | `Unknown` | ✅ | [verify-apple-intel-macos-12-monterey-unknown-pass-b8fa44ff.txt](../references/verification-results/verify-apple-intel-macos-12-monterey-unknown-pass-b8fa44ff.txt) |
| **Apple Silicon** | macOS 15 Sequoia | **Unknown** | `Unknown` | ❌ | [verify-apple-silicon-macos-15-sequoia-unknown-fail-50c777c3.txt](../references/verification-results/verify-apple-silicon-macos-15-sequoia-unknown-fail-50c777c3.txt) |
...
| **Linux Workstation** | Linux | **Unknown** | `Unknown` | ✅ | [verify-linux-workstation-linux-unknown-pass-b2774dd6.txt](../references/verification-results/verify-linux-workstation-linux-unknown-pass-b2774dd6.txt) |
