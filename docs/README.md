...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Apple Intel** | macOS 11+ | **Colima** | ![Colima](https://img.shields.io/badge/Colima-Hardened-FFAB00?style=flat-square&logo=apple) | ✅ | [verify-apple-intel-macos-11-colima-pass-b8fa44ff.txt](../references/verification-results/verify-apple-intel-macos-11-colima-pass-b8fa44ff.txt) |
