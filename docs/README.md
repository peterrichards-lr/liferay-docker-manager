...
| **Apple Silicon** | macOS 26 Tahoe | **Colima** `v` | `v29.2.1` | ![Colima](https://img.shields.io/badge/Colima-Hardened-FFAB00?style=flat-square&logo=apple) | `2.4.26-pre.13` | ✅ | [verify-apple-silicon-macos-26-tahoe-colima-pass-68556025.txt](../references/verification-results/verify-apple-silicon-macos-26-tahoe-colima-pass-68556025.txt) |
...
| **Linux Workstation** | Fedora 43 | **Native Docker** `v29.4.1` | `v29.4.1` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26-pre.13` | ✅ | [verify-linux-workstation-fedora-43-native-docker-pass-7493ead5.txt](../references/verification-results/verify-linux-workstation-fedora-43-native-docker-pass-7493ead5.txt) |
| **Windows PC** | Windows 11 | **Docker Desktop** `v$dv"` | `v29.4.0` | ![DockerDesktop](https://img.shields.io/badge/Docker_Desktop-Hardened-00C853?style=flat-square&logo=windows) | `2.4.26-pre.13` | ✅ | [verify-windows-pc-windows-11-docker-desktop-pass-7b2d2180.txt](../references/verification-results/verify-windows-pc-windows-11-docker-desktop-pass-7b2d2180.txt) |
| **Windows PC** | Windows 11 | **Native WSL2** `v29.3.0` | `v29.3.0` | ![WSL2](https://img.shields.io/badge/WSL2-Hardened-blue?style=flat-square&logo=windows) | `2.4.26-pre.13` | ✅ | [verify-windows-pc-windows-11-native-wsl2-pass-abfd9648.txt](../references/verification-results/verify-windows-pc-windows-11-native-wsl2-pass-abfd9648.txt) |
