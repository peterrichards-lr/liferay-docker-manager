...
| **Apple Silicon** | macOS 26 Tahoe | **Colima** `v0.10.1` | `29.2.1` | ![Colima](https://img.shields.io/badge/Colima-Hardened-FFAB00?style=flat-square&logo=apple) | `2.4.41-pre.1` | ✅ | [verify-apple-silicon-macos-26-tahoe-colima-pass-d44f73aa.txt](../references/verification-results/verify-apple-silicon-macos-26-tahoe-colima-pass-d44f73aa.txt) |
...
| **Linux Workstation** | Fedora 43 | **Native Docker** | `29.4.1` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26` | ✅ | [verify-linux-workstation-fedora-43-native-docker-pass-cb4cc4db.txt](../references/verification-results/verify-linux-workstation-fedora-43-native-docker-pass-cb4cc4db.txt) |
...
| **Windows PC** | Windows 11 | **Native WSL2** `WSL 2.4.4` | `29.3.0` | ![WSL2](https://img.shields.io/badge/WSL2-Hardened-blue?style=flat-square&logo=windows) | `2.4.26` | ✅ | [verify-windows-pc-windows-11-native-wsl2-pass-cc07c100.txt](../references/verification-results/verify-windows-pc-windows-11-native-wsl2-pass-cc07c100.txt) |
