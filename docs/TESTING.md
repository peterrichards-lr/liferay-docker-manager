...
| **Linux Workstation** | Fedora 44 | **Native Docker** | `29.7.2` | ![Linux](https://img.shields.io/badge/Linux-Hardening-success?style=flat-square&logo=linux) | `2.19.0-pre.3` | ✅ | [verify-linux-workstation-fedora-44-native-docker-pass.txt](../references/verification-results/verify-linux-workstation-fedora-44-native-docker-pass.txt) |
