...
| **Windows PC** | Windows 11 | **Docker Desktop** | ![DockerDesktop](https://img.shields.io/badge/Docker_Desktop-Hardened-00C853?style=flat-square&logo=windows) | ❌ | [verify-windows-pc-windows-11-docker-desktop-fail-f7977f0a.txt](../references/verification-results/verify-windows-pc-windows-11-docker-desktop-fail-f7977f0a.txt) |
