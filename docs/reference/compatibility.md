...
| **Apple Silicon** | macOS 15 Sequoia | **Colima** | `29.2.1` | ![Colima](https://img.shields.io/badge/Colima-Hardening-FFAB00?style=flat-square&logo=apple) | `2.15.16-pre.10` | ✅ | [verify-apple-silicon-macos-15-sequoia-colima-pass.txt](../../references/verification-results/verify-apple-silicon-macos-15-sequoia-colima-pass.txt) |
...
| **Linux Workstation** | Ubuntu 24.04 | **Native Docker** | `29.3.0` | ![Linux](https://img.shields.io/badge/Linux-Hardening-success?style=flat-square&logo=linux) | `2.15.16-pre.10` | ✅ | [verify-linux-workstation-ubuntu-24.04-native-docker-pass.txt](../../references/verification-results/verify-linux-workstation-ubuntu-24.04-native-docker-pass.txt) |
