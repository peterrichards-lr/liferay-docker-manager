...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Apple Intel** | macOS 12 Monterey | **Colima** | `v29.2.1` | ![Colima](https://img.shields.io/badge/Colima-Hardened-FFAB00?style=flat-square&logo=apple) | `2.4.26-beta.35` | ❌ | [verify-apple-intel-macos-12-monterey-colima-fail-4c24fb87.txt](../references/verification-results/verify-apple-intel-macos-12-monterey-colima-fail-4c24fb87.txt) |
...
| **Linux Workstation** | Fedora | **Native Docker** | `Unknown` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26-beta.30` | ✅ | [verify-linux-workstation-fedora-native-docker-pass-0d59206b.txt](../references/verification-results/verify-linux-workstation-fedora-native-docker-pass-0d59206b.txt) |
| **Linux Workstation** | Fedora 43 | **Native Docker** | `v29.4.1` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26-pre.3` | ✅ | [verify-linux-workstation-fedora-43-native-docker-pass-14c2be85.txt](../references/verification-results/verify-linux-workstation-fedora-43-native-docker-pass-14c2be85.txt) |
| **Windows PC** | Windows 11 | **Docker Desktop** | `v29.4.0` | ![DockerDesktop](https://img.shields.io/badge/Docker_Desktop-Hardened-00C853?style=flat-square&logo=windows) | `2.4.26-pre.3` | ✅ | [verify-windows-pc-windows-11-docker-desktop-pass-3d82ee5a.txt](../references/verification-results/verify-windows-pc-windows-11-docker-desktop-pass-3d82ee5a.txt) |
| **Windows PC** | Windows 11 | **Native WSL2** | `v29.3.0` | ![WSL2](https://img.shields.io/badge/WSL2-Hardened-blue?style=flat-square&logo=windows) | `2.4.26-pre.3` | ✅ | [verify-windows-pc-windows-11-native-wsl2-pass-489455ee.txt](../references/verification-results/verify-windows-pc-windows-11-native-wsl2-pass-489455ee.txt) |
