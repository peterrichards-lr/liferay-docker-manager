...
| **Apple Silicon** | macOS 26 Tahoe | **OrbStack** `v1.9.4` | `v29.4.0` | ![OrbStack](https://img.shields.io/badge/OrbStack-Hardened-00B0FF?style=flat-square&logo=apple) | `2.4.26-beta.43` | ✅ | [verify-apple-silicon-macos-26-tahoe-orbstack-pass-ce5a6995.txt](../references/verification-results/verify-apple-silicon-macos-26-tahoe-orbstack-pass-ce5a6995.txt) |
| **Linux Workstation** | Fedora | **Native Docker** | `Unknown` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26-beta.30` | ✅ | [verify-linux-workstation-fedora-native-docker-pass-6181c9f8.txt](../references/verification-results/verify-linux-workstation-fedora-native-docker-pass-6181c9f8.txt) |
| **Linux Workstation** | Fedora 43 | **Native Docker** | `v29.4.1` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26-pre.3` | ✅ | [verify-linux-workstation-fedora-43-native-docker-pass-ee0220c4.txt](../references/verification-results/verify-linux-workstation-fedora-43-native-docker-pass-ee0220c4.txt) |
| **Windows PC** | Windows 11 | **Docker Desktop** `v4.35.0` | `v29.4.0` | ![DockerDesktop](https://img.shields.io/badge/Docker_Desktop-Hardened-00C853?style=flat-square&logo=windows) | `2.4.26-pre.3` | ✅ | [verify-windows-pc-windows-11-docker-desktop-pass-fb211f66.txt](../references/verification-results/verify-windows-pc-windows-11-docker-desktop-pass-fb211f66.txt) |
| **Windows PC** | Windows 11 | **Native WSL2** `WSL 2.4.4` | `v29.3.0` | ![WSL2](https://img.shields.io/badge/WSL2-Hardened-blue?style=flat-square&logo=windows) | `2.4.26-pre.3` | ✅ | [verify-windows-pc-windows-11-native-wsl2-pass-f6533205.txt](../references/verification-results/verify-windows-pc-windows-11-native-wsl2-pass-f6533205.txt) |
