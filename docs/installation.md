...
| **Linux Workstation** | Fedora | **Unknown** | `29.5.0` | `Unknown` | `2.7.2-beta.73` | ❌ | [verify-linux-workstation-fedora-unknown-fail-1b88cc00.txt](../references/verification-results/verify-linux-workstation-fedora-unknown-fail-1b88cc00.txt) |
| **Linux Workstation** | Fedora 43 | **Native Docker** | `29.4.1` | ![Linux](https://img.shields.io/badge/Linux-Native-success?style=flat-square&logo=linux) | `2.4.26` | ✅ | [verify-linux-workstation-fedora-43-native-docker-pass-dd7f49be.txt](../references/verification-results/verify-linux-workstation-fedora-43-native-docker-pass-dd7f49be.txt) |
| **Linux Workstation** | Ubuntu 24.04 | **Unknown** | `29.3.0` | `Unknown` | `2.7.2-beta.73` | ❌ | [verify-linux-workstation-ubuntu-24.04-unknown-fail-cf85eebd.txt](../references/verification-results/verify-linux-workstation-ubuntu-24.04-unknown-fail-cf85eebd.txt) |
...
| **Windows PC** | Windows 11 | **Native WSL2** `WSL 2.4.4` | `29.3.0` | ![WSL2](https://img.shields.io/badge/WSL2-Hardened-blue?style=flat-square&logo=windows) | `2.7.2-beta.51` | ❌ | [verify-windows-pc-windows-11-native-wsl2-fail-994d56ee.txt](../references/verification-results/verify-windows-pc-windows-11-native-wsl2-fail-994d56ee.txt) |
