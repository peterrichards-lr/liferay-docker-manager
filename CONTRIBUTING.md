...
3. **Pass the Lint Check**: Before submitting, you MUST run the local linting script:
   ...
   - **Pytest** (Unit Tests)
   - **Markdownlint** (Docs)
4. **Update Documentation**: If you change or add a command, or modify existing logic, please update the relevant files in the `docs/` folder. This requirement applies to all changes, including those assisted or generated by AI.
